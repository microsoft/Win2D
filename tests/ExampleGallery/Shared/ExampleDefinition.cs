...
namespace ExampleGallery
{
    ...
    public class ExampleDefinitions
    {
        ...
        public ExampleDefinitions()
        {
            ...
            this.definitions.Add(new ExampleDefinition() { Name = "Arc Options", Control = typeof(ArcOptions) });
            this.definitions.Add(new ExampleDefinition() { Name = "Custom Fonts", Control = typeof(CustomFonts) });
