...
namespace MathTests
{
	...
	inline bool Equal(Vector2 a, Vector2 b)
	{
		return Equal(a.X, b.X) && Equal(a.Y, b.Y);
	}

	inline bool Equal(Vector3 a, Vector3 b)
	{
		return Equal(a.X, b.X) && Equal(a.Y, b.Y) && Equal(a.Z, b.Z);
	}

	inline bool Equal(Vector4 a, Vector4 b)
	{
		return Equal(a.X, b.X) && Equal(a.Y, b.Y) && Equal(a.Z, b.Z) && Equal(a.W, b.W);
	}

	inline bool Equal(Matrix4x4 a, Matrix4x4 b)
	{
	...
	inline bool Equal(Matrix3x2 a, Matrix3x2 b)
	{
	...
	inline bool Equal(Plane a, Plane b)
	{
		return Equal(a.Normal, b.Normal) && Equal(a.D, b.D);
	}

	inline bool Equal(Quaternion a, Quaternion b)
	{
		return Equal(a.X, b.X) && Equal(a.Y, b.Y) && Equal(a.Z, b.Z) && Equal(a.W, b.W);
	}
