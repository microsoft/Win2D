...
namespace Windows.Math
{
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public static implicit operator Windows.Foundation.Size(Vector2 value)
        {
            return new Windows.Foundation.Size(value.X, value.Y);
        }


        public static implicit operator Vector2(Windows.Foundation.Point value)
        {
            Vector2 result;
        ...
        public static implicit operator Vector2(Windows.Foundation.Size value)
        {
            Vector2 result;
