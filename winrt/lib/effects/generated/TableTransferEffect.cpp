...
namespace ABI { namespace Microsoft { namespace Graphics { namespace Canvas { namespace Effects
{
        ...
        : CanvasEffect(CLSID_D2D1TableTransfer, 9, 1, true)
    {
        ...
        SetProperty<boolean>(D2D1_TABLETRANSFER_PROP_RED_DISABLE, static_cast<boolean>(false));
        SetArrayProperty<float>(D2D1_TABLETRANSFER_PROP_GREEN_TABLE, { 0.0, 1.0 });
        SetProperty<boolean>(D2D1_TABLETRANSFER_PROP_GREEN_DISABLE, static_cast<boolean>(false));
        SetArrayProperty<float>(D2D1_TABLETRANSFER_PROP_BLUE_TABLE, { 0.0, 1.0 });
        SetProperty<boolean>(D2D1_TABLETRANSFER_PROP_BLUE_DISABLE, static_cast<boolean>(false));
        SetArrayProperty<float>(D2D1_TABLETRANSFER_PROP_ALPHA_TABLE, { 0.0, 1.0 });
        SetProperty<boolean>(D2D1_TABLETRANSFER_PROP_ALPHA_DISABLE, static_cast<boolean>(false));
