...
namespace canvas
{
    ...
    {
    public:
        MOCK_METHOD0_CONST(GetFillMode, D2D1_FILL_MODE());
        MOCK_METHOD0_CONST(GetSourceGeometryCount, UINT32());
        MOCK_METHOD2_CONST(GetSourceGeometries, void(ID2D1Geometry**, UINT32));
