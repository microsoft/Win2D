...
namespace canvas
{
    class MockD2DRoundedRectangleGeometry : public RuntimeClass<
        RuntimeClassFlags<ClassicCom>,
        ChainInterfaces<ID2D1RoundedRectangleGeometry, ID2D1Geometry, ID2D1Resource>>
    {
    public:
        CALL_COUNTER_WITH_MOCK(GetRoundedRectMethod, void(D2D1_ROUNDED_RECT*));
        ...
        STDMETHOD_(void, GetRoundedRect)(
            D2D1_ROUNDED_RECT *roundedRect) const override
        {
            GetRoundedRectMethod.WasCalled(roundedRect);
        }
