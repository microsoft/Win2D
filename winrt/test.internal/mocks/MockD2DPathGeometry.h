...
namespace canvas
{
    ...
    {
    public:
        MOCK_METHOD5_CONST(ComputePointAndSegmentAtLength, HRESULT(FLOAT, UINT32, CONST D2D1_MATRIX_3X2_F*, FLOAT, D2D1_POINT_DESCRIPTION*));

        MOCK_METHOD1(Open, HRESULT(ID2D1GeometrySink**));
        MOCK_METHOD1_CONST(Stream, HRESULT(ID2D1GeometrySink*));
        MOCK_METHOD1_CONST(GetSegmentCount, HRESULT(UINT32*));
        MOCK_METHOD1_CONST(GetFigureCount, HRESULT(UINT32*));
