...
namespace canvas
{
...
#else
        IFACEMETHODIMP add_Changed(__FITypedEventHandler_2_Microsoft__CUI__CXaml__CXamlRoot_Microsoft__CUI__CXaml__CXamlRootChangedEventArgs* handler, EventRegistrationToken* token) override
#endif
        {
    ...
    class StubUserControlWithXamlRoot : public StubUserControl, public RuntimeClass<IUIElement>
    {
    ...
    public:
        ...
        IFACEMETHODIMP QueryInterface(REFIID riid, void** ppvObject) override
        {
            ...
            {
                return RuntimeClass<IUIElement>::QueryInterface(riid, ppvObject);
            }
            return hr;
        }
