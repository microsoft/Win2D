...
// Interop between Platform::Numerics and DirectXMath.
namespace DirectX
{
    XMVECTOR XM_CALLCONV XMLoadFloat2    (_In_ Platform::Numerics::float2     const* pSource);
    XMVECTOR XM_CALLCONV XMLoadFloat3    (_In_ Platform::Numerics::float3     const* pSource);
    XMVECTOR XM_CALLCONV XMLoadFloat4    (_In_ Platform::Numerics::float4     const* pSource);
    XMMATRIX XM_CALLCONV XMLoadFloat3x2  (_In_ Platform::Numerics::float3x2   const* pSource);
    XMMATRIX XM_CALLCONV XMLoadFloat4x4  (_In_ Platform::Numerics::float4x4   const* pSource);
    XMVECTOR XM_CALLCONV XMLoadPlane     (_In_ Platform::Numerics::plane      const* pSource);
    XMVECTOR XM_CALLCONV XMLoadQuaternion(_In_ Platform::Numerics::quaternion const* pSource);

    void XM_CALLCONV XMStoreFloat2    (_Out_ Platform::Numerics::float2*     pDestination, _In_ FXMVECTOR value);
    void XM_CALLCONV XMStoreFloat3    (_Out_ Platform::Numerics::float3*     pDestination, _In_ FXMVECTOR value);
    void XM_CALLCONV XMStoreFloat4    (_Out_ Platform::Numerics::float4*     pDestination, _In_ FXMVECTOR value);
    void XM_CALLCONV XMStoreFloat3x2  (_Out_ Platform::Numerics::float3x2*   pDestination, _In_ FXMMATRIX value);
    void XM_CALLCONV XMStoreFloat4x4  (_Out_ Platform::Numerics::float4x4*   pDestination, _In_ FXMMATRIX value);
    void XM_CALLCONV XMStorePlane     (_Out_ Platform::Numerics::plane*      pDestination, _In_ FXMVECTOR value);
    void XM_CALLCONV XMStoreQuaternion(_Out_ Platform::Numerics::quaternion* pDestination, _In_ FXMVECTOR value);
}
